...
export const PsychologyBooksSection = () => {
  ...
  return (
    <section id="class12-psychology-books-section" style={{ marginTop: '1rem', marginBottom: '2rem', minWidth: 0, width: '100%', maxWidth: '100%' }}>
          ...
          filteredChapters.map((item) => (
            ...
            >
              ...
              <div style={{
                ...
                >
                  <Download size={15} />
                  <span>Download Psychology Notes</span>
                </a>
              </div>
            </div>
          ))
